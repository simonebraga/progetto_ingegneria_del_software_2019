...
public class DamageTrack {
     ...
     * @throws KilledPlayerException when the target player gets killed or overkilled
     */
    public void addDamage(Player player, Integer n) throws KilledPlayerException {
