...
class TestGameMapGetVisibilityTwoDoors {
    ...
    void setUp() {
        ...
        grid[1][1] = new Square(Border.WALL, Border.NOTHING, Border.NOTHING, Border.WALL);
        expectedVisibility.add(grid[1][1]);
        grid[1][2] = new Square(Border.WALL, Border.DOOR, Border.WALL, Border.WALL);
        ...
        grid[2][1] = new Square(Border.NOTHING, Border.WALL, Border.NOTHING, Border.DOOR);
        expectedVisibility.add(grid[2][1]);
        grid[2][2] = new Square(Border.DOOR, Border.WALL, Border.DOOR, Border.WALL);
